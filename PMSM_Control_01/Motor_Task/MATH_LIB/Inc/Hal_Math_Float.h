...
} Sensor_Hysteresis_Comp_TypeDef_f32_t;
...
inline float Lookup_Table_Linear_f32(float x, Lookup_Table_f32_t *table);
...
inline void Sensor_Hysteresis_Comp_Process_f32(Sensor_Hysteresis_Comp_TypeDef_f32_t *hcomp, float analog_input);
