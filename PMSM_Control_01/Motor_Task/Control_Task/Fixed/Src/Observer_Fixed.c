...
struct EMF_Cal_Parameter EMF_Cal_Fixed = {0};
...
/*有效磁链观测器*/
struct EffFluxObserver_Parameter EffFlux_OB_Fixed = 
{
...
void Observer_Param_Lookup_Updata_Fixed(Motor_Control_t *pMotor_Control, q31_t Speed, q31_t Is, q31_t Ts)
{
    ...
    struct Motor_Config_Fixed *pMotor_Config = (struct Motor_Config_Fixed *)pMotor_Control->Motor_Config;
#ifdef MOTOR_NONFLUX_OBSERVER
