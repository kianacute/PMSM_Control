...
// /*有效磁链观测器*/
// struct EffFluxObserver_Parameter_Fixed EffFlux_OB_Fixed = 
// {
...
//     EffFlux_OB_Fixed.PLL_PI.kp = 200 / 1;
...
//     EffFlux_OB_Fixed.gama = 0;
//     EffFlux_OB_Fixed.x_alpha_hat = 0;
//     EffFlux_OB_Fixed.x_beta_hat = 0;
//     EffFlux_OB_Fixed.y_alpha_hat = 0;
//     EffFlux_OB_Fixed.y_beta_hat = 0;
//     EffFlux_OB_Fixed.Eta_alpha = 0;
//     EffFlux_OB_Fixed.Eta_beta = 0;
//     EffFlux_OB_Fixed.Flux_hat = 0;
//     EffFlux_OB_Fixed.Flux_alpha = 0;
//     EffFlux_OB_Fixed.Flux_beta = 0;
//     EffFlux_OB_Fixed.we = 0;
//     EffFlux_OB_Fixed.theta = 0;
...
// {
//     struct EffFluxObserver_Parameter_Fixed *EFO = (struct EffFluxObserver_Parameter_Fixed*)pMotor_control->pObserver;
...
// void Observer_Param_Lookup_Updata_Fixed(Motor_Control_t *pMotor_Control, float Speed, float Is, float Ts)
// {
