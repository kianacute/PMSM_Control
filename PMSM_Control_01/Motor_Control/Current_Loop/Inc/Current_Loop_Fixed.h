...
typedef struct Current_Loop_Fixed
{
    ...
    int16_t Ud_Target, Uq_Target;                             
    int16_t Id_Ref, Iq_Ref;
    int16_t Id_fb, Iq_fb;
    int16_t Is_fb;
    int16_t Ualpha_Ref, Ubeta_Ref, sinVal, cosVal;
    int16_t theta;
    int16_t ialpha_fb, ibeta_fb;
    int16_t Ia_fb, Ib_fb, Ic_fb;
    int32_t Ia_fb_offset, Ib_fb_offset, Ic_fb_offset;
    int16_t PWM_duty_a, PWM_duty_b, PWM_duty_c;
    uint8_t sector;
    int16_t PWM_FREQ_Coeff;                               //变载频系数，PWM_FREQ_Coeff = CUR_HZ / FREQ_HZ
